...
- 思源黑体 `Noto Sans SC`、思源宋体 `Noto Serif SC`（fontsource 可变，分 unicode-range 分包）
- 霞鹜文楷 `LXGW WenKai`（Lite 常用字集；**为控体积只内嵌 regular 400 + bold 700 普通体，不含 light 及 Mono 变体**）、得意黑 `Smiley Sans Oblique`（cn-fontsource，单字重）
- 朱雀仿宋 `Zhuque Fangsong`（仿宋/宋朝感，TTF，OFL）、霞鹜漫黑 `LXGW Marker Gothic`（手帐感黑体，TTF，OFL）、Maple Mono CN `Maple Mono CN`（中英 2:1 等宽圆角，TTF，OFL）
- 站酷庆科黄油体 `ZCOOL QingKe HuangYou`、站酷小薇 `ZCOOL XiaoWei`（fontsource 分包，OFL，展示用）

整包约 56MB（TTF 字体较大：Maple Mono CN ~18MB、朱雀 ~8MB），明细见 `assets/fonts/MANIFEST.md`。
...
- **更纱黑体 Sarasa Gothic SC / Sarasa Mono SC**：OFL，但官方仅发 TTC/7z，无干净 woff2/ttf 源，在「curl + python3 标准库零依赖」约束下未自动内嵌。仿宋/编辑角色回退思源宋或朱雀仿宋；CJK 等宽角色回退 Maple Mono CN；如出现可嵌入 webfont 再手动加入并在 `fonts.css` 补 `@font-face`。
...
| 授权 | 含义 | 字体 |
|---|---|---|
| SIL OFL-1.1 | 自由商用/内嵌/子集化/分发 | 思源黑、思源宋、霞鹜文楷、得意黑、朱雀仿宋、霞鹜漫黑、Maple Mono CN、站酷庆科黄油体、站酷小薇；Geist、Geist Mono、Space Grotesk、Newsreader、Source Serif 4、Spectral、IBM Plex Mono、Libre Caslon Display |
...
|---|---|---|---|---|
| `magazine-eink` | Cabinet Grotesk\* · Newsreader / 思源宋 700\* · 得意黑(封面≤1) · 站酷小薇(封面≤1) | Spectral\* · Source Serif 4 / 思源宋\* · 朱雀仿宋 · 霞鹜文楷 | General Sans\* · Satoshi / 思源黑\* | Geist Mono\* · IBM Plex Mono |
...
| `newsroom-paper` | Newsreader 700\* · Cabinet Grotesk / 思源宋 700\* · 站酷庆科黄油体(封面≤1) | Newsreader\* · Spectral / 思源宋\* | General Sans\* · Geist / 思源黑\* | IBM Plex Mono\* · Geist Mono |
...
| `product-manual` | Space Grotesk\* · Geist 700 / 思源黑 700\* | Source Serif 4 · — / 思源宋 | Geist\* · Satoshi / 思源黑\* | Geist Mono\* · IBM Plex Mono · Maple Mono CN(CJK) |
| `engineering-paper` | Space Grotesk 600\* · Geist 700 / 思源黑 700\* | — | Geist\* · General Sans / 思源黑\* | Geist Mono\* · IBM Plex Mono · Maple Mono CN(CJK) |
| `field-notes` | Newsreader\* · Spectral / 思源宋 600\* | Spectral\* · Source Serif 4 / 霞鹜文楷\* · 朱雀仿宋 · 思源宋 | General Sans\* · Geist / 思源黑\* · 霞鹜文楷 · 霞鹜漫黑 | IBM Plex Mono\* · Geist Mono · Maple Mono CN(CJK) |
| `kraft-editorial` | Libre Caslon Display\* · Newsreader / 思源宋 700\* · 站酷小薇(封面≤1) | Spectral\* · Newsreader / 霞鹜文楷\* · 朱雀仿宋 · 思源宋 | General Sans\* · Satoshi / 思源黑\* | Geist Mono\* · IBM Plex Mono |
...
| `social-notebook` | Cabinet Grotesk 800\* · Satoshi / 思源黑 900\* · 得意黑(封面≤1) · 站酷庆科黄油体(封面≤1) · 站酷小薇(封面≤1) | Newsreader · — / 思源宋 | Satoshi\* · Geist / 思源黑\* · 霞鹜漫黑 | Geist Mono\* · IBM Plex Mono · Maple Mono CN(CJK) |
| `bold-editorial` | Cabinet Grotesk 800\* · Space Grotesk / 思源宋 900\* · 得意黑(封面≤1) · 站酷庆科黄油体(封面≤1) | Newsreader\* · Spectral / 思源宋\* · 朱雀仿宋 · 霞鹜文楷 | Satoshi\* · General Sans / 思源黑\* | Geist Mono\* · IBM Plex Mono |

新增中文字体的定位：**朱雀仿宋**=编辑/文学/历史感宋体（与思源宋同档备选）；**霞鹜漫黑**=手帐/教程/生活方式的亲和黑体（与霞鹜文楷同档）；**站酷庆科黄油体**=复古招牌/重磅封面，**站酷小薇**=文艺/轻古典封面（均为单字重展示体，标 `(封面≤1)`，每套封面最多 1 处，等同得意黑约束）；**Maple Mono CN**=可含中文的等宽体，标 `(CJK)`，仅当 footer/数据标签/代码块含中文时优先于 Geist Mono / IBM Plex Mono。
...
:root{
  ...
  /* 新增中文字体可选链（缺失自动回退已内嵌字体）： */
  --font-fangsong:"Source Serif 4", "Zhuque Fangsong", "Noto Serif SC", serif; /* 编辑/文学/历史感 */
  --font-marker:  "LXGW Marker Gothic", "Noto Sans SC", sans-serif;            /* 手帐/教程/生活方式 */
  --font-mono-cjk:"Maple Mono CN", "Geist Mono", "Noto Sans SC", ui-monospace, monospace; /* 含中文的等宽 */
  /* 展示标题（单字重，封面≤1，纯中文场景）： */
  --font-poster:  "ZCOOL QingKe HuangYou", "Noto Sans SC", sans-serif;          /* 复古招牌/重磅 */
  --font-poster-lit:"ZCOOL XiaoWei", "Noto Serif SC", serif;                    /* 文艺/轻古典 */
}
